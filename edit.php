...
?>
  <div class="container">
    ...
    <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
      ...
      <input type="hidden" name="id" value="<?= $contact['CodCliente'] ?>">
      <div class="form-group">
        <label for="name">Nome do contato:</label>
        <input type="text" class="form-control" id="Nome" name="name" placeholder="Digite o nome" value="<?= $contact['Nome'] ?>" required>
      </div>
      <div class="form-group">
